...
Mobile.setText(findTestObject('Login/email'), 'rezamuhammadsaput@gmail.com', 0)

Mobile.setText(findTestObject('Login/pass'), '16amberegul', 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.Button - SIGN IN'), 0)

Mobile.setText(findTestObject('Login/resend email'), 'rezamuhammadsaput@gmail.com', 0)
